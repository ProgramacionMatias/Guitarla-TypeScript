...
// lo creamos aqui solamente porque lo ocuparemos en este componente
...
export default function Header({ cart, dispatch }: HeaderProps) {
    ...
    // useMemo funciona cuando no quieres hacer tantos render y solo los necesarios con los[] se ejecuta solo cuando el carrito sea modificado
